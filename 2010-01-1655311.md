...
> 原文发表于 2010-01-24, 地址: http://www.cnblogs.com/chenxizhang/archive/2010/01/24/1655311.html 
...
<script type="text/javascript">  
 ...
 $(this).addClass('focus'); 
 if ($(this).hasClass('have\_tooltip')) { 
 $(this).parent().parent().removeClass('field\_normal').addClass('field\_focus'); 
 } 
 }); 
 ...
 if ($(this).hasClass('have\_tooltip')) { 
 $(this).parent().parent().removeClass('field\_focus').addClass('field\_normal'); 
 } 
 });*/  
    });  
</script>  
...
<form id="secondform">      
    <fieldset>  
        ...
        <div id="xb" class="owinput">  
            <div class="owlabel">  
                <label class="req" for="confirm\_pwd"> 密码确认 :</label>  
            </div>  
            <div class="owfield">  
                <span class="inp"> <input name="confirm\_pwd" type="text"> </span>  
            </div>  
        </div>  
