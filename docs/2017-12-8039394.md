...
没有什么特别的，除了你需要定义一个表格，然后把这个文件保存在你的OneDrive for Business中即可。（你在第一行输入标题后，选择A1，然后在“插入”菜单中选择“表格”）接下来，你要做的是打开[https://preview.web.powerapps.com](https://preview.web.powerapps.com/)这个在线的应用开发平台，用你的账号（不管是Office 365账号，还是Dynamics 365账号，或者单独的PowerApps账号）[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/web.powerapps.portal.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/web.powerapps.portal.png)点击左侧的Apps，然后选择右上角的"Create an app"[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-create-apps.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-create-apps.png)选择“OneDrive for Business” 里面的“Phone Layout”[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-onedrive-excel.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-onedrive-excel.png)如果你是第一次运行，则可以通过下面的界面创建一个连接[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-onedrive-createconnection.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-onedrive-createconnection.PNG)如果你之前已经创建过连接，则定位到并单击你保存的Excel文件，PowerApps会自动检测文件内部的表格，选中其中一个表格后，点击右下角的Connect按钮[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-onedrive-selectexcel.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-onedrive-selectexcel.png)一两分钟后，你就能看到一个自动生成的应用[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-app.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-app.png)我们这里先不展开细节，可以直接按F5运行这个应用[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-1.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-1.png)点击右上角的加号（+），可以输入订单信息[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-2.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-2.png)点击右上角的勾号，可以保存当前这条记录，并且自动给回到主界面，此时会显示所有的订单列表[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-3.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-3.png)如果点击某条记录，则会进入订单的详细界面[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-4.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-4.png)点击右上角的笔形按钮，可以进入订单的编辑视图[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-2.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-2.png)到这里为止，我们就完成了一个最简单、但确实能立即工作的轻业务应用，你已经在预览界面中进行了操作，接下来要做的是什么呢？当然是保存这个应用啦。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-5.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-5.PNG)然后你可以将应用分享给需要的同事[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-6.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-6.PNG)点击“Share this app” 按钮, 你可以一次性添加公司中所有同事，让他们可以使用这个app，也可以单独添加某个同事。后面这种情况下，你还可以授权给这位同事可以一起编辑。如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-share-app.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-share-app.png)我们指定分享的同事会收到一封邮件，大致如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-share-app-email.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-share-app-email.png)如果他点击了“Use the app”的话，会弹出下面的页面，要求他进行授权[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-share-permission.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-share-permission.png)这里的授权，主要是希望得到用户的许可，OneDrive for Business可以代表用户去进行必要的操作。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-onedrive-permission.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-onedrive-permission.PNG)但这里需要特别注意的是，如果该同事并没有被授予访问上面提到这个Excel文件的权限的话，虽然能打开OrderApp，但无法读取任何数据，也无法进行操作。作为应用的作者，我需要在OneDrive for Business中选择该文件，然后给同事授予访问权限。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-onedrive-grantpermission.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-onedrive-grantpermission.PNG)到现在为止，一个最简单但足够实用的应用就创建好了，你可以通过网页版（<https://web.powerapps.com/home>) 进行访问，也可以通过免费的一个Windows桌面客户端（PowerApps）来进行使用。但用得最多的场景，我估计是使用手机吧。目前PowerApps这个应用可以在Apple Store和Google Play等应用市场中免费下载。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-ios.jpg)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-ios.jpg)这个PowerApps其实相当于是一个超级App，它负责来运行我们自定义的业务应用。打开这个PowerApps，输入账号和密码登陆后，可以看到你有权使用的所有应用。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-applist.jpg)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-applist.jpg)点击某个应用，你就可以进行数据查询和操作了，这一点都不奇怪，以至于我都不想多做截图了。我这里要给大家做一个提示的是，如果某个应用你需要经常使用，你甚至可以将它固定在手机的屏幕上面，而无需每次都进入PowerApps这个主界面，然后再查找了。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-pinttohome.jpg)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-pinttohome.jpg)最后，所有用户在PowerApps中操作的数据，都将统一保存在Excel文件中。值得注意的是，PowerApps会在表格中增加一个特殊的列：\_\_ PowerAppsId \_\_ 用来唯一标识每一行。[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/powerapps-excel-result.PNG)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/powerapps-excel-result.PNG)以上我用了很长的篇幅，完整地介绍了如何基于OneDrive for Business中保存的一个Excel文件快速开发一个业务应用，并且分发给公司里面的同事，他们可以有多种方式进行使用的场景。接下来，我将继续展示两个最典型的场景。基于SharePoint Online的列表创建轻业务应用
=============================
