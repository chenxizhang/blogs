...
![](./images/7904255-office365application-20.PNG)##### [注册中国版Microsoft Graph应用程序](https://chenxizhang.gitbooks.io/office365devguide/docs/chinaoffice365applicationregisteration.html)

![](./images/7904255-gallatin-nativeapplicationsample.PNG)创建Console Application
=====================

不要问我怎么做这个事情，你应该知道的。 

![](./images/7904255-graph-createconsoleapplication.png)
...
 ![](./images/7904255-active-directory-oauth-code-flow-native-app.png)
...
![](./images/7904255-graphsdk.PNG)具体到我们本篇文章的目标，如果Office 365是国际版，你可以使用Microsoft Graph Client Library <https://www.nuget.org/packages/Microsoft.Graph/> 

  


![](./images/7904255-microsoftgraphclientlib.PNG)
...
 ![](./images/7904255-graph-consoleapp-ww-login.PNG)
...
 ![](./images/7904255-graph-consoleapp-ww-auth.PNG)

不出意外的话，你现在就可以在控制台窗口中看到当前登录的用户信息，十个邮件标题等信息了。VB.NET 开发人员看过来
==============
...
![](./images/7904255-graph-consoleapplicationsample.PNG)
