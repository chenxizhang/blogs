...
Yammer是Office 365中的一个企业级社交网络，你可以根据需要创建各种各样的群组（Yammer Group），讨论不同的话题。在Yammer群组中，你也可以通过在“组操作”中选择“添加或删除应用”这个操作，如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-36-56.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-36-56.png)这里显示的连接器列表其实跟在Outlook里面看到的是一样的[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-28-39.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-28-39.png)本例演示添加“RSS”这个连接器，例如我关注Office 产品组的更新博客，就可以通过下面的方式订阅他们的RSS feed[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-21-10-59.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-21-10-59.png)点击“保存”后，会在Yammer群组中看到一个通知[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-21-11-29.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-21-11-29.png)在设定的时间，RSS引擎会把博客链接发送到Yammer群组中来[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-21-13-15.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-21-13-15.png)在Microsoft Teams中使用Office 365 Connectors
========================================

Microsoft Teams是Office 365 Connectors另外一个使用场景，它的用法略有不同：它是在频道中添加连接器的，一个团队可以有多个频道，一个频道有可以添加多个连接器，这样就带来了更加灵活的可能性。选择某个团队的某个频道，在它右侧的“...”菜单中选择“连接器”，你可以看到跟之前很类似的一个界面[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-17-55-16.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-17-55-16.png)在本例中，我演示的是如何配置Yammer这个连接器以便在Teams中能收到Yammer讨论组的消息。和Github类似，添加Yammer这个连接器后，要进行详细的配置，如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-17-56-53.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-17-56-53.png)你可以设置要关注的组，事件类型，关注的用户和关键字，以及通知的频率等等，保存后，当Yammer组有状态更新时，在频道里面就可以收到通知：[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-17-59-47.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-17-59-47.png)在这里可以直接点赞，或者回复，不过似乎这些还不能双向地同步到Yammer里面来。自定义Office 365 Connectors
========================

上面演示了使用Office 365 Connectors的场景（Outlook，Yammer，Microsoft Teams），我们都是使用目前内置的Connectors，那么如果我们自己有一个应用系统，也想通过这种方式进行连接（在必要的时候推送消息和更新动态），应该怎么来做呢？这方面，目前Office 365平台提供了三种机制。首先，对于一些简单的场景，你可以直接使用“Incoming Webhook”这个内置的连接器来定义，如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-47-53.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-47-53.png)通常你只需要提供一个名称即可完成连接器的定义[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-49-33.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-49-33.png)点击“创建”，会产生一个Url，这就是可以用来推送消息的地址了[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-50-47.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-50-47.png)那么，如何使用这个自定义的连接器呢？很简单，我们只要在应用程序内部，通过Post的方法，给这个地址发送消息即可。通常的代码如下：
```
using System;
...
```
运行这个小程序，就可以在目标应用中收到一个通知的消息，如下图所示[![](https://github.com/chenxizhang/office365dev/raw/master/docs/images/2018-03-12-20-58-40.png)](https://github.com/chenxizhang/office365dev/blob/master/docs/images/2018-03-12-20-58-40.png)
